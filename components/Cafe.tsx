    ...
    <>
        ...
        <div className="container">
          <div className="cafe-hero-grid">
            <div>
              ...
              <p className="intro">
                คาเฟ่เจลาโต้และเพสตรี้สูตรเฉพาะของบ้านมานะชัย เจลาโต้คาชิวคั่วใหม่ทุกเช้า
                ขนมอบสด เคียงกับกาแฟ specialty ในระยะเดินไม่กี่ก้าวจากร้านคาชิวของเรา
              </p>
        ...
        <div className="signature">
          ...
          <div>
            ...
            <p>
              ...
              ปั่นกับครีมและคาราเมลโฮมเมด รสชาติที่หาที่ไหนไม่ได้ เสิร์ฟพร้อมคุกกี้คาชิวอบสด
            </p>
      ...
      <section className="container" id="menu">
        <header className="section-header">
          ...
          <p className="lede">
            เจลาโต้ปั่นในร้านทุกเช้า เพสตรี้อบสด และเครื่องดื่มที่จับคู่กับคาชิวของเราเสมอ
          </p>
        </header>
