...
export const promoSets: PromoSet[] = [
  {
    ...
    items: [
      ...
      "เม็ดมะม่วงหิมพานต์คั่วข้าว 175g",
      "เม็ดมะม่วงหิมพานต์มีเปลือกคั่วเกลือ 175g",
    ],
    price: "฿—",
  },
  {
    ...
    items: [
      ...
      "เม็ดมะม่วงหิมพานต์คั่วข้าว",
      "เม็ดมะม่วงหิมพานต์มีเปลือกคั่วเกลือ",
      "อัลมอนด์",
      "พิตาชิโอ",
      "เม็ดฟักทอง",
    ],
...
// Premium creations that USE our roasted cashews as an ingredient (made & sold
// at Cafe mana·san). Add more here — th/en names, a short note, and a price.
export const cashewCreations: {
  th: string;
  en: string;
  note: string;
  price?: string;
}[] = [
  {
    th: "เจลาโต้รสกาหยู",
    en: "Cashew Gelato",
    note: "เจลาโต้เนื้อนุ่ม ปั่นจากกาหยูคั่วเองของบ้านมานะชัย หอมมันจากไขมันดีธรรมชาติ",
    price: "฿89",
  },
  {
    th: "กาหยูคาราเมลมัคคิอาโต้",
    en: "Kayuu Caramel Macchiato",
    note: "กาแฟคาราเมลกลิ่นกาหยูคั่ว รสละมุนเย็นชื่นใจ",
    price: "฿90",
  },
];
